...
public class LupdpmessageEntity {
    ...
    public boolean equals(Object o) {
        ...
        LupdpmessageEntity entity = (LupdpmessageEntity) o;

        if (id != null ? !id.equals(entity.id) : entity.id != null) return false;
        if (cloudappid != null ? !cloudappid.equals(entity.cloudappid) : entity.cloudappid != null) return false;
        ...
        if (updater != null ? !updater.equals(entity.updater) : entity.updater != null) return false;
        ...
        if (operationtype != null ? !operationtype.equals(entity.operationtype) : entity.operationtype != null)
            return false;
        if (newid != null ? !newid.equals(entity.newid) : entity.newid != null) return false;
        if (messagetoid != null ? !messagetoid.equals(entity.messagetoid) : entity.messagetoid != null) return false;
        if (startid != null ? !startid.equals(entity.startid) : entity.startid != null) return false;
        if (isread != null ? !isread.equals(entity.isread) : entity.isread != null) return false;
        if (starttype != null ? !starttype.equals(entity.starttype) : entity.starttype != null) return false;
        if (isreceive != null ? !isreceive.equals(entity.isreceive) : entity.isreceive != null) return false;
        if (nickname != null ? !nickname.equals(entity.nickname) : entity.nickname != null) return false;
        if (signature != null ? !signature.equals(entity.signature) : entity.signature != null) return false;
        if (picpath != null ? !picpath.equals(entity.picpath) : entity.picpath != null) return false;
        if (isdelete != null ? !isdelete.equals(entity.isdelete) : entity.isdelete != null) return false;
        if (!Arrays.equals(sharereason, entity.sharereason)) return false;
